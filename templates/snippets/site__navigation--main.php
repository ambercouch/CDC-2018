              ...
              <div class="header--master__lang-switch">
                <div class="social-nav--header">
                  <div class="c-search-form">
                    <svg class="c-search-form__control icon icon-search icon--header" data-state="off" data-control="search-header"><use xlink:href="#icon-search"></use></svg>
                    <form data-state="off" class="searchform c-search-form__form" method="get" id="searchform-header"  data-container="search-header" action="<?php echo esc_url(home_url('/')); ?>" role="search">
